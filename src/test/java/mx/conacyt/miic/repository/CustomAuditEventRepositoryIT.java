package mx.conacyt.miic.repository;

import mx.conacyt.miic.CienciaApp;
import mx.conacyt.miic.config.Constants;
import mx.conacyt.miic.config.audit.AuditEventConverter;
import mx.conacyt.miic.domain.PersistentAuditEvent;
...
import static mx.conacyt.miic.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
